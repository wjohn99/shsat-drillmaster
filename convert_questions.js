...
// Output the converted questions
console.log('Converted Questions:');
console.log(JSON.stringify(convertedQuestions, null, 2));

// Also output just the first few for verification
console.log('\nFirst 3 converted questions:');
